...
echo "Started at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
nohup python3 processImages.py -a /home/pam/data/micropics/after -b /home/pam/data/micropics/before -d /home/pam/data/micropics/workingSet_morphed -f 4 -g 0 -m 4 -o sgd -e 10 >> ${resultsFile}
echo "Finished/killed at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
