...
def save_models(step, g_model_AtoB, g_model_BtoA, destDir=""):
...
def train(d_model_A, d_model_B, g_model_AtoB, g_model_BtoA, c_model_AtoB, c_model_BtoA, dataset, destDir=""):
    ...
    for i in range(n_steps):
        ...
        if (i+1) % (bat_per_epo * 5) == 0:
            # save the models
            save_models(i, g_model_AtoB, g_model_BtoA, destDir=destDir)
...
if __name__ == "__main__":
    ...
    # train models
    train(d_model_A, d_model_B, g_model_AtoB, g_model_BtoA, c_model_AtoB, c_model_BtoA, dataset, destDir=destDir)
