...
echo "Started at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
nohup python3 processImages.py -a /home/pam/data/micropics/after -b /home/pam/data/micropics/before -d ${workingDir} -f 0 -g 0 -m 6 -o sgd -e 10 >> ${resultsFile}
echo "Finished/killed at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}

echo "Started at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
nohup python3 processImages.py -a /home/pam/data/micropics/after -b /home/pam/data/micropics/before -d ${workingDir} -f 0 -g 0 -m 6 -o adam -e 10 >> ${resultsFile}
echo "Finished/killed at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}

echo "Started at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
nohup python3 processImages.py -a /home/pam/data/micropics/after -b /home/pam/data/micropics/before -d ${workingDir} -f 0 -g 0 -m 6 -o rmsprop -e 10 >> ${resultsFile}
echo "Finished/killed at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}

echo "Started at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
nohup python3 processImages.py -a /home/pam/data/micropics/after -b /home/pam/data/micropics/before -d ${workingDir} -f 0 -g 0 -m 6 -o adadelta -e 10 >> ${resultsFile}
echo "Finished/killed at:" >> ${resultsFile}
echo $(date) >> ${resultsFile}
